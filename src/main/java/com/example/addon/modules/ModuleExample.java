...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(GrisUtils.CATEGORY, "world-origin", "An module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link GrisUtils#getPackage()} to be setup correctly, otherwise the game will crash whenever the module is enabled.
     */
    @EventHandler
